...
export function SimplifyPopup({ paragraph, onUseOriginal, onUseModified, onDismiss }: SimplifyPopupProps) {
  ...
  const panelClass =
    'relative z-50 flex max-h-[90vh] w-full max-w-2xl flex-col overflow-hidden rounded-xl border border-gray-200 bg-white shadow-2xl';

  const sectionClass = 'rounded-lg border border-gray-200 bg-gray-50 p-3 text-sm text-gray-900';
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
      ...
      <div className={panelClass}>
        <div className="flex items-center justify-between border-b border-gray-100 px-4 py-3">
          <h3 className="text-sm font-semibold text-gray-900">Simplify</h3>
        ...
        <div className="space-y-4 overflow-y-auto px-4 py-4">
          <div className={sectionClass}>
            <div className="flex items-center justify-between gap-2">
              <p className="text-xs font-semibold uppercase tracking-wide text-gray-600">Original</p>
              <button
                type="button"
          ...
          <div className={sectionClass}>
            <p className="text-xs font-semibold uppercase tracking-wide text-gray-600">Version A</p>
          ...
          <div className={sectionClass}>
            <p className="text-xs font-semibold uppercase tracking-wide text-gray-600">Version B</p>
          ...
          <div className="flex justify-end">
            <button
              ...
              className="rounded-lg border border-gray-300 px-3 py-2 text-sm text-gray-800 hover:bg-gray-50 disabled:opacity-50"
              onClick={async () => {
                if (!state.settings) return;
                try {
                  const raw = await simplify(activeSource, state.settings);
